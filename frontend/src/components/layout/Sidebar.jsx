...
export default function Sidebar() {
  return (
    <aside className="fixed top-0 left-0 h-screen w-64 bg-surface border-r border-borderMain flex flex-col z-50">
      ...
      {/* Bottom Section */}
      <div className="p-4 border-t border-borderMain space-y-3">
        ...
        <button
          ...
          className="flex items-center gap-3 w-full px-4 py-2.5 rounded-xl text-sm font-medium text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-all duration-200"
        >
          <LogOut size={18} />
          Log Out
        </button>
