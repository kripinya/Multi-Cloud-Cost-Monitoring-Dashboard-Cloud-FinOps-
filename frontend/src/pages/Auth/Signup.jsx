...
import { Eye, EyeOff, UserPlus, CloudLightning } from 'lucide-react';
        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4" style={{ marginLeft: '-16rem' }}>
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-textMain tracking-tight">Create your account</h1>
                    <p className="text-textMuted text-sm mt-1">Start monitoring your cloud costs</p>
                </div>
